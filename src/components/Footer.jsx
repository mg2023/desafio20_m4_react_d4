...
import logo from "../solodetodo.png"
        ...
        >
          <CDBBox display="flex" alignItems="center">
            <a href="/" className="d-flex align-items-center p-0 text-dark">
              ...
              // width="30px"
              />
              {/* <span className="ml-4 h5 mb-0 font-weight-bold">SolodeTodo</span> */}
            </a>
          </CDBBox>
          <CDBBox>
            <small className="ml-2">&copy; Solo de todo, 2022. All rights reserved.</small>
          </CDBBox>
          <CDBBox display="flex">
